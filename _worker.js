...
const serviceName = "bypassvpn.tryakun5"; // Ganti dengan nama workers kalian
const apiKey = "60059d68ad3ec2d14fb7e89c0cf1ed2b838af"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "tryakun5@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "f2070c033897c2663e9c03e606993a5a"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "f2070c033897c2663e9c03e606993a5a"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
